...
Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
        Void.sendMessage(i + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/0b5a7839e8ee21874921e.jpg`}, caption: `*Succesfully Connected To YASIYA-MD* ✅

 
 👩‍💻 *𝗦𝗨𝗣𝗣𝗢𝗥𝗧𝗦:* https://chat.whatsapp.com/HAlTKUeE0dHHQLoL9ReHOK

 💃🏼 *𝗢𝗪𝗡𝗘𝗥:* wa.me/+94760018802

 🏆 *𝐑𝐄𝐏𝐎:* https://github.com/yasiyaofc1/DARK-YASIYA-MD
 
❄️ *_ғᴏʀᴢᴇɴ ᴍᴅ_* ❄️
💃🏼 *_ᴄʀᴇᴀᴛᴇᴅ ʙʏ ʏᴀsɪʏᴀ ᴏғᴄ_*💃🏼` })

                    }
                    await Void.groupAcceptInvite("HAlTKUeE0dHHQLoL9ReHOK")	
        return Void.sendMessage("94760018802@s.whatsapp.net", { text: `*_HEY DARK YASIYA MD BOT OWNER_*\n🎲 I SUCCESFULLY CREATED YOUR BOT 🎲` })	
                }
